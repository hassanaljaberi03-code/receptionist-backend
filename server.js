...
//
// 4) healthcheck (du kan beholde den her, den bruges til at teste at serveren kører)
...
app.post("/voice", async (req, res) => {
  try {
    ...
    const response = await fetch(`https://api.elevenlabs.io/v1/text-to-speech/4RklGmuxoAskAbGXplXN`, {
      method: "POST",
      headers: {
